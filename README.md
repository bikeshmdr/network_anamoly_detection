...
<p>
    <ol>
        ...
        <li>Class distribution is observed:<br>
            <p>
            <img src = "data_cleaning/class_distribution.png" width = "500">
            </p>
            ...
            <ul>
                <li>OrdinalEncoding is performed to all the object columns with modification to handle unseen data as well:</li>
                    <li>Skewness and Correlation between features is calculated:<br>
                        <p><img src = "data_cleaning/skewness.png" width = "500"></p>
                        <p><img src = "data_cleaning/correlation.png" width = "500"></p>
                    </li> 
                </li>
            </ul>
        <li>EDA<br>
            ...
            <p><img src = "data_cleaning/src_bytes_1.png" width = "500"></p>
            <p><img src = "data_cleaning/src_bytes_2.png" width = "500"></p>
            <p><img src = "data_cleaning/dst_bytes_1.png" width = "500"></p>
            <p><img src = "data_cleaning/dst_bytes_2.png" width = "500"></p>
        </li>
        <li>Standardization
...
<p>
    <ul>
        <li>Elbos Method<br>
            ...
            <p><img src = "model_training/elbow.png" width = "500"></p>
        </li>
        <li>KMean clustering<br>
            ...
            <p><img src = "model_training/cluster.png" width = "500"></p>
        </li>
        <li> Gaussian Mixture model <br>
            ...
            <p><img src = "model_training/gaussian.png" width = "500"></p>
        </li>
    </ul>
</p>

<h1>Model Comparison</h1>
<p><img src = "model_training/model_evaluation.png" width = "500"></p>
